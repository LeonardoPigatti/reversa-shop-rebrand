const SOCIAL_ICONS = [
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/leonardovm.pigatti/',
    svg: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/leonardopigatti/',
    svg: (
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/@lojareversaoficial',
    svg: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Pinterest',
    href: 'https://br.pinterest.com/leonardoviniciusmilanipigatti/',
    svg: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Spotify',
    href: 'https://open.spotify.com/user/22xpfgbgpgbtyzezc3spkih3y?si=f6b84121f3b14a36',
    svg: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'TikTok',
    href: 'https://www.tiktok.com/@marimoonoficial',
    svg: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
